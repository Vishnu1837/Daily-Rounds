...
export function OnboardingWizard({
  ...
  const canAdvance = useMemo(() => {
    switch (current.key) {
      ...
      case 'baseline':
        return (
          baselineDays !== null && baselineConsistency !== null && baselineConfidence !== null
        );
      case 'obstacle':
      ...
      <Card className="overflow-hidden">
        ...
        <div className="px-5 pt-6 pb-5">
          ...
          <div key={current.key} className="animate-step-in min-h-[22rem]">
              <h1 className="text-xl font-extrabold text-balance text-fg">{current.title}</h1>

              {current.key === 'welcome' && (
                <div className="mt-4 space-y-4">
                  <p className="text-sm leading-relaxed text-fg-muted">
                    You almost certainly already have enough study material. What is hard is
                    sitting down and doing the work you said you would, day after day.
                  </p>
                  <p className="text-sm leading-relaxed text-fg-muted">
                    Daily Rounds measures one thing:{' '}
                    <strong className="text-fg">did you show up?</strong> Not how clever you are.
                    Not your marks. Whether you turned up and did what you committed to.
                  </p>
                  <ul className="space-y-2.5 rounded-2xl bg-bg-sunken p-4">
                    {[
                      ...
                      <li key={text} className="flex items-center gap-3 text-sm font-medium text-fg">
              ...
              {current.key === 'subject' && (
                <div className="mt-5 space-y-4">
                  <p className="text-sm text-fg-muted">
                    Everyone in the cohort works on their own subject — your roadmap is yours
                    alone.
                  </p>
                  <Select
